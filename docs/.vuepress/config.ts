...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        ...
        items: [
          ...
          { text: '架构图', link: '/pages/0dbcd0/' },
          { text: '开源框架', link: '/pages/40f623be692cf8bc/' },
          { text: '产品服务', link: '/pages/f1acb712033ac8da/' },
          { text: '产品脚本', link: '/pages/9fece0/' },
        ],
      },
      {
        text: 'git仓库',
    ...
    // repo: 'http://192.168.4.1/', // 导航栏右侧生成Github链接
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:864620188@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/lixingweii',
        }
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        '海乂知成都后端技术文档', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
